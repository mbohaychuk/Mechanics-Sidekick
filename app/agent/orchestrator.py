...
SYSTEM_PROMPT = (
    ...
    "'ENGINE - 5.0L 32V TI-VCT | ...'); prefer excerpts whose engine matches this vehicle, and if the "
    "only relevant spec or procedure is from a different engine's section, say so explicitly instead "
    "of presenting it as this vehicle's. When a "
